...
public abstract class ParticipantRegistrationsServiceBase : IParticipantRegistrationsService
{
    ...
    /// </summary>
    public async Task<ParticipantRegistration> CreateParticipantRegistration(ParticipantRegistrationCreateInput createDto)
    {
...
var result = await _context.FindAsync<ParticipantRegistrationDbModel>(participantRegistration.Id);
...
return result.ToDto();}
    ...
    /// </summary>
    public async Task DeleteParticipantRegistration(ParticipantRegistrationWhereUniqueInput uniqueId)
{
    var participantRegistration = await _context.ParticipantRegistrations.FindAsync(uniqueId.Id);
...
/// </summary>
public async Task<List<ParticipantRegistration>> ParticipantRegistrations(ParticipantRegistrationFindManyArgs findManyArgs)
{
  ...
  .ToListAsync();
    return participantRegistrations.ConvertAll(participantRegistration => participantRegistration.ToDto());
}

/// <summary>
/// Meta data about ParticipantRegistration records
/// </summary>
public async Task<MetadataDto> ParticipantRegistrationsMeta(ParticipantRegistrationFindManyArgs findManyArgs)
{
...
/// </summary>
public async Task<ParticipantRegistration> ParticipantRegistration(ParticipantRegistrationWhereUniqueInput uniqueId)
{
    var participantRegistrations = await this.ParticipantRegistrations(
              new ParticipantRegistrationFindManyArgs { Where = new ParticipantRegistrationWhereInput { Id = uniqueId.Id } }
  );
...
/// </summary>
public async Task UpdateParticipantRegistration(ParticipantRegistrationWhereUniqueInput uniqueId, ParticipantRegistrationUpdateInput updateDto)
{
...
public async Task<Event> GetEvent(ParticipantRegistrationWhereUniqueInput uniqueId)
{
    var participantRegistration = await _context
          .ParticipantRegistrations.Where(participantRegistration => participantRegistration.Id == uniqueId.Id)
